  ...
  return (
    <div>
        ...
        <div>
          ...
          <div className='flex'>
            <button className=' bg-white text-lg font-medium flex flex-row rounded-md py-1 pr-5 pl-3 hover:bg-gray-300'><BsFillPlayFill className='text-3xl mr-1'/> Play</button>
