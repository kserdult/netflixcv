...
function Movie({item}) {
  return (
    <div className=' w-[50%] sm:w-[33.33%] md:w-[25%] lg:w-[20%] xl:w-[16.6%] relative inline-block mx-[0.2vw]'>
      <item.IconTitle className="text-white bg-red-900 w-full h-[25vw] sm:h-[20vw] md:h-[15vw] lg:h-[12vw] object-cover rounded-md block"/>
